            ...
            expect(api.get).toHaveBeenCalledWith({
                ...
                data: {
                    ...
                    fields: {
                        ...
                        contact: 'name',
                        tasks: 'activity_contacts,activity_type,completed,completed_at,no_date,contacts,starred,start_at,subject,tag_list,comments_count,location,result,notification_type,notification_time_before,notification_time_unit,subject_hidden'
                    }
                },

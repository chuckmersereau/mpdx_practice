...
export class HelpService {
    constructor(
        ...
        try {
            ...
            // only debug log as we don't want rollbar cluttered by people using adblockers
    ...
    showHelp(): void {
        try {
            ...
            // fallback to opening help in a new tab
            this.$window.open('https://mpdx.helpscoutdocs.com', '_blank');
        }
    }

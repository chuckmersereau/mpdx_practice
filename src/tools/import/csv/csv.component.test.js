...
describe('tools.import.csv.component', () => {
    let $ctrl, rootScope, scope, componentController, transitions, state, importCsv, modal;
    beforeEach(() => {
        angular.mock.module(component);
        inject(($componentController, $rootScope, $transitions, $state, _importCsv_, _modal_) => {
            rootScope = $rootScope;
            scope = rootScope.$new();
            ...
            describe('success function', () => {
                ...
                describe('importCsv data is not empty', () => {
                    ...
                    it('should return promise', () => {
                        expect(callbacks.success()).toEqual(jasmine.any(Promise));
                    });
    ...
    describe('$onDestroy', () => {
        ...
        it('should call deregisterTransitionHook function', () => {
            ...
            spyOn($ctrl, 'deregisterTransitionHook').and.returnValue();
            $ctrl.$onDestroy();

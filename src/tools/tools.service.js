class ToolsService {
    ...
    constructor(
        ...
        this.data = [
            ...
            {title: gettextCatalog.getString('Fix Commitment Info'), icon: 'fa fa-usd', link: 'tools.fixCommitmentInfo', description: gettextCatalog.getString('Set the correct contacts commitment info for each contact'), enabled: true},

class ToolsService {
    ...
    constructor(
        ...
        this.data = [
            ...
            {title: gettextCatalog.getString('Fix Phone Numbers'), icon: 'fa fa-phone-square', link: 'tools.fix.phoneNumbers', description: gettextCatalog.getString('Set the correct primary phone number for each person'), enabled: false},
            {title: gettextCatalog.getString('Fix Email Addresses'), icon: 'fa fa-envelope-o', link: 'tools.fix.emailAddresseses', description: gettextCatalog.getString('Set the correct primary email address for each person'), enabled: false},
            {title: gettextCatalog.getString('Fix Mailing Addresses'), icon: 'fa fa-map', link: 'tools.fix.addresses', description: gettextCatalog.getString('Set the correct primary mailing address for each contact'), enabled: false},

...
describe('tools.fix.sendNewsletter.item.component', () => {
    let $ctrl, rootScope, scope, componentController, blockUI, fixSendNewsletter, contact;
    beforeEach(() => {
        angular.mock.module(component);
        inject(($componentController, $rootScope, _blockUI_, _fixSendNewsletter_) => {
            rootScope = $rootScope;
            scope = rootScope.$new();
            blockUI = _blockUI_;
    ...
    describe('save', () => {
        beforeEach(() => {
            spyOn(fixSendNewsletter, 'save').and.callFake(() => Promise.resolve());
        });

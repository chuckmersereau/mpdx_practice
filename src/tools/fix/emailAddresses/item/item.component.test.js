...
describe('tools.fix.emailAddresses.item.component', () => {
    let $ctrl, rootScope, scope, componentController, blockUI, fixEmailAddresses, person;
    beforeEach(() => {
        angular.mock.module(component);
        inject(($componentController, $rootScope, _blockUI_, _fixEmailAddresses_) => {
            rootScope = $rootScope;
            scope = rootScope.$new();
            blockUI = _blockUI_;
    ...
    describe('save', () => {
        beforeEach(() => {
            spyOn(fixEmailAddresses, 'save').and.callFake(() => Promise.resolve());
        });

...
describe('tools.fix.sendNewsletter.service', () => {
    let api, contacts, fixSendNewsletter, tools, q, rootScope;

    beforeEach(() => {
        angular.mock.module(service);
        inject(($rootScope, _api_, _contacts_, _fixSendNewsletter_, _tools_, $q) => {
            api = _api_;
            contacts = _contacts_;
    ...
    describe('load', () => {
        ...
        it('should return a promise', () => {
            expect(fixSendNewsletter.load()).toEqual(jasmine.any(q));
        });
            ...
            describe('data set', () => {
                ...
                describe('reset set to false', () => {
                    describe('page is current page', () => {
                        ...
                        it('should return a promise', () => {
                            expect(fixSendNewsletter.load(false, 1)).toEqual(jasmine.any(q));
                        });
                    });
    ...
    describe('save', () => {
        ...
        it('should return a promise', () => {
            expect(fixSendNewsletter.save(contact)).toEqual(jasmine.any(q));
        });
        ...
        describe('promise successful', () => {
            beforeEach(() => {
                spyOn(fixSendNewsletter, 'removeContactFromData').and.callFake(() => {});
            });
    ...
    describe('removeContactFromData', () => {
        ...
        describe('data not empty', () => {
            beforeEach(() => {
                spyOn(fixSendNewsletter, 'load').and.callFake(() => {});
    ...
    describe('bulkSave', () => {
        ...
        it('should return a promise', () => {
            expect(fixSendNewsletter.bulkSave('MPDX')).toEqual(jasmine.any(q));
        });

...
describe('tools.mergePeople.component', () => {
    let $ctrl, rootScope, scope, componentController, alerts, gettextCatalog, state, api, people, tools;
    beforeEach(() => {
        angular.mock.module(component);
        inject(($componentController, $rootScope, $state, _alerts_, _api_, _gettextCatalog_, _people_, _tools_) => {
            rootScope = $rootScope;
            scope = rootScope.$new();
            alerts = _alerts_;
            api = _api_;
    ...
    describe('load', () => {
        ...
        it('should map data', (done) => {
            let data = [{ id: 1, records: [{ id: 'person_1_id' }, { id: 'person_2_id' }] }];

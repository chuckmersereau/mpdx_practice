...
describe('reports.contributions.component', () => {
    let $ctrl, rootScope, scope, serverConstants, componentController, api, designationAccounts, gettextCatalog;
    beforeEach(() => {
        angular.mock.module(component);
        inject((
            $componentController, $rootScope, _serverConstants_, _api_, _designationAccounts_, _gettextCatalog_
        ) => {
            rootScope = $rootScope;
            scope = rootScope.$new();
            api = _api_;
